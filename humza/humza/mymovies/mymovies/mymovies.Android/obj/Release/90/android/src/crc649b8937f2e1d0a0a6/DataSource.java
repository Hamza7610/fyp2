...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("mymovies.Droid.Services.DataSource, mymovies.Android", DataSource.class, __md_methods);
	}
	...
	public DataSource ()
	{
		...
		if (getClass () == DataSource.class)
			mono.android.TypeManager.Activate ("mymovies.Droid.Services.DataSource, mymovies.Android", "", this, new java.lang.Object[] {  });
	}
